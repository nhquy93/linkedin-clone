...
describe('FeedController', () => {
    ...
    mockRequest.user.firstName = 'user1';
    ...
    it('should create a feed post', () => {
        expect(feedController.create(mockFeedPost, mockRequest.user)).toEqual({
            id: expect.any(Number),
            ...mockFeedPost
        });
    });

    it('should get 2 feed post, skipping the first', () => {
