import { Body, Controller, Get, Param, Post, Put, Request, Res, UploadedFile, UseGuards, UseInterceptors } from '@nestjs/common';
...
export class UserController {
    ...
    uploadImage(
        ...
        return isFileExtensionSafe(fullImagePath)
            .pipe(
    ...
    findImage(@Request() req, @Res() res): Observable<Object> {
        const userId = req.user.id;
        return this.userService.findImageNameByUserId(userId)
            .pipe(
    ...
    respondToFriendRequest(
        ...
        return this.userService
            .respondToFriendRequest(statusResponse.status, friendRequestId);
    }
